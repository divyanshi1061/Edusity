...
const Contact_us = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "79a4f028-de51-4d4e-8b93-86fbfc752fa9");
...
<ul>
  ...
  <li><img src={location_icon} alt="" /> ABC University, XYZ City</li>
  </ul></div> 
   <div className="contact-col">
    <form onSubmit={onSubmit}><label>Your Name</label>
